...
### Instructions (EN/US)
Repository developed for educational purposes, providing support materials for the **Contributing to an Open Source Project on GitHub** lab from [Digital Innovation One](https://www.dio.me/).

[![Link Lab](https://img.shields.io/badge/▶-000?style=for-the-badge&logo=movie&logoColor=E94D5F)](https://web.dio.me/lab/desafio-de-projeto-contribuindo-em-um-projeto-open-source-no-github/learning/913f26fd-1018-4643-b59a-6356ea77dc2e) 
[![Link Lab](https://img.shields.io/badge/Acesse%20o%20Lab%20na%20Plataforma-E94D5F?style=for-the-badge)](https://web.dio.me/lab/desafio-de-projeto-contribuindo-em-um-projeto-open-source-no-github/learning/913f26fd-1018-4643-b59a-6356ea77dc2e)

### Instrucciones (ES/ESPAÑOL)
Repositorio desarrollado con fines educativos, que proporciona materiales de apoyo para el laboratorio **Contribuir a un Proyecto de Código Abierto en GitHub** de [Digital Innovation One](https://www.dio.me/).

[![Enlace al Laboratorio](https://img.shields.io/badge/▶-000?style=for-the-badge&logo=movie&logoColor=E94D5F)](https://web.dio.me/lab/desafio-de-projeto-contribuindo-em-um-projeto-open-source-no-github/learning/913f26fd-1018-4643-b59a-6356ea77dc2e) 
[![Enlace al Laboratorio](https://img.shields.io/badge/Acesse%20o%20Lab%20na%20Plataforma-E94D5F?style=for-the-badge)](https://web.dio.me/lab/desafio-de-projeto-contribuindo-em-um-projeto-open-source-no-github/learning/913f26fd-1018-4643-b59a-6356ea77dc2e)
...
### Instructions (EN/US)
Learn the basics of contributing on GitHub.

### Instrucciones (ES/ESPAÑOL)
Aprende los fundamentos de la contribución en GitHub.
...
---
##  Desafio: Profile README [Instruções (PT/BR)]
...
##  Challenge: Profile README [Instructions (EN)]
Contribute to the "Community" directory by creating a Profile README containing information about yourself that you would like to share with the community. You can include: badges indicating your skills; cards with your GitHub statistics and projects you've created, contributed to, or would like others to collaborate on. Additionally, you can also include links to your project challenges and articles on the [Digital Innovation One](https://www.dio.me/) platform. <br>
 Get inspired by checking out the examples in the [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community), folder, explore some utilities in the [`utils`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/utils) folder, and use your creativity to create your own 😊💙.
...
##  Reto: Perfil README [Instrucciones (ES/ESPAÑOL)]
Contribuye al directorio "Community" creando un Perfil README que contenga información sobre ti que desees compartir con la comunidad. Puedes incluir: insignias que indiquen tus habilidades; tarjetas con tus estadísticas de GitHub y proyectos que hayas creado, contribuido o en los que desees que otros colaboren. Además, también puedes incluir enlaces a tus desafíos de proyectos y artículos en la plataforma de [Digital Innovation One](https://www.dio.me/). <br>
Inspírate revisando los ejemplos en la carpeta [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community), explora algunas utilidades en la carpeta [`utils`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/utils) y usa tu creatividad para crear el tuyo 😊💙.

1. Realiza un **Fork** de este repositorio;
2. Clona localmente: `git clone https://github.com/TUUSUARIO/dio-lab-open-source.git`;
3. Agrega el control remoto "upstream" para mantener actualizado tu repositorio local: `git remote add upstream https://github.com/elidianaandrade/dio-lab-open-source.git`;
    > Utiliza el comando `git pull upstream main` para descargar y fusionar los cambios en tu repositorio local basado en la rama `main` de este repositorio original del cual hiciste el fork, o `git fetch upstream main` para descargar sin fusionar. Mira más en: [Primeros Pasos con Git y GitHub](https://github.com/elidianaandrade/dio-curso-git-github/blob/main/materiais-de-apoio/03-primeiros-passos-com-git-e-github.md).
4. Crea una nueva **rama** y dale el nombre `feat/community/TUUSUARIO`: `git checkout -b feat/community/TUUSUARIO`;
    > Ejemplo: ´git checkout -b feat/community/elidianaandrade´
5. Dentro de la carpeta [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community), crea un archivo en formato Markdown (extensión `.md`) y dale el mismo nombre que tu usuario en GitHub;
    > Ejemplo: `elidianaandrade.md` <br>
6. Desarrolla tu perfil. Para hacerlo, puedes ver ejemplos en la carpeta [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community) y agregar algunas de las utilidades presentes en la carpeta [`utils`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/utils);
    > *Nota:** Utiliza los otros ejemplos como inspiración y no los copies directamente.
7. Agrega tus cambios al "área de preparación" con el comando `git add community/TUUSUARIO.md`;
8. Crea un commit y agrega un mensaje que indique la adición de tu perfil `git commit -m"feat: agregar perfil de TUUSUARIO"`;
9. Envía los cambios a tu repositorio remoto  `git push origin feat/community/TUUSUARIO`; 
...
## Contribua - Contribute - Contribuir
